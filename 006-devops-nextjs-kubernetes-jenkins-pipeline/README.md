...
> CI/CD (Continuous Integration / Continuous Delivery veya Deployment), yazılım geliştirme sürecinde kodun sürekli olarak entegre edilip test edilmesini ve otomatik şekilde dağıtıma hazır hale getirilmesini sağlayan bir pratiktir. CI kısmı, geliştiricilerin yaptığı kod değişikliklerinin sık sık ortak bir repoya birleştirilip otomatik testlerden geçirilmesini ifade eder. CD ise bu testlerden geçen kodun otomatik veya yarı otomatik şekilde production ortamına kadar güvenli bir şekilde taşınmasını sağlar.
...
D:\workspace\006-devops-nextjs-kubernetes-jenkins-pipeline\devops-terraform\02_MontitoringServer
içindeki 03_install.sh  

---
prometheus ve node_exporter sürümlerini güncelle
...
---
```
cd  D:\workspace\devops\devops-06-pipeline-aws\devops-terraform\02_MontitoringServer
```
...
https://github.com/huseyinaydin99/devops/006-devops-nextjs-kubernetes-jenkins-pipeline/settings/hooks
